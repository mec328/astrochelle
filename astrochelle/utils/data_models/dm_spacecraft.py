...
class SpacecraftConfig(BaseModel):
    id: int = Field(0, description = "unique spacecraft identifier") # TODO, have this generate automatically on initialization
    ...
    effective_area_drag: float = Field(1, description = "effective drag area [m^2]")
    effective_area_srp: float = Field(1, description = "effective SRP area [m^2]")

    @validator('mass','coefficient_drag','coefficient_srp','effective_area_drag','effective_area_srp')
    @classmethod
